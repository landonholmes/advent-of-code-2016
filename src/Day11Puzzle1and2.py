instructions = """The first floor contains a strontium generator, a strontium-compatible microchip, a plutonium generator, and a plutonium-compatible microchip.
...
indicies = ['stg', 'stm', 'plg', 'plm', 'thg', 'thm', 'rug', 'rum', 'cug', 'cum', 'elg', 'elm', 'dlg', 'dlm']
