instructions = """bot 37 gives low to bot 114 and high to bot 150
...
while bot:
    for k,v in dict(bot).items():
        if len(v) == 2:
            ...
            if v1==17 and v2==61: print 'bot responsible for 17 and 61: ', k
...
print 'total value multiplied of outputs 0,1,2: ', (a*b*c)
